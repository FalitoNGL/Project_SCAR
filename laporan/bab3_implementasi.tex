...
Keenam berkas \texttt{.pkl} (\textit{pickle}) di atas merupakan representasi biner statis dari komputasi pelatihan fase *cloud*. Rasio 6 berkas untuk 4 model fusi dijelaskan sebagai berikut:
\begin{itemize}
